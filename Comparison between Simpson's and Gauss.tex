...
\begin{figure}[h]
\includegraphics{images/errocos(2x^2)}
...
\begin{figure}[h]
\includegraphics{images/erroe^x^2}
...
\begin{figure}[h]
\includegraphics{images/erroex^21+3x^7+45x^2}
...
\begin{figure}[h]
\includegraphics{images/erroex^21+3x^7+45x^2convergindo}
